		...
		<div class="container">
			<div class="row m-rl--1">
					...
					<div class="col-md-12 p-rl-1">
						<div class="row m-rl--1">
						<?php 
							$show=mysqli_query($koneksi,"SELECT * FROM berita")or die(mysqli_error($show));

							while($data=mysqli_fetch_assoc($show)){
						?>
							<div class="col-6 p-rl-1 p-b-2">
								<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url(upload/<?php echo $data['foto']?>);">
									...
									<div class="flex-col-e-s s-full p-rl-25 p-tb-24">
										...
										<h3 class="how1-child2 m-t-14">
											<a href="blog-detail-01.php?id_berita=<?php echo $data['id_berita']?>" class="how-txt1 size-a-7 f1-l-2 cl0 hov-cl10 trans-03">
												<?php echo $data['judul']?>
											</a>
										</h3>
									</div>
